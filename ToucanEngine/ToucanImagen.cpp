...
//Set Rotation
void ToucanImagen::SetRotation(float _angle)
{
	angle = _angle;
}
...
//Set Scale
void ToucanImagen::SetScale(float _x, float _y)
{
	scalex = _x;
	scaley = _y;
}
//Set Scale Overload
void ToucanImagen::SetScale(Vector2 _xy)
{
	scalex = _xy.x;
	scaley = _xy.y;
}
